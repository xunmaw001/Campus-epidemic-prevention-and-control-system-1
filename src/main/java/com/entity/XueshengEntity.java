...
public class XueshengEntity<T> implements Serializable {
	 ...
	 * 设置：住址省份
	 */
	public void setZhuzhishengfen(String zhuzhishengfen) {
		this.zhuzhishengfen = zhuzhishengfen;
	}
	/**
	 * 获取：住址省份
	 */
	public String getZhuzhishengfen() {
		return zhuzhishengfen;
	}
	/**
	 * 设置：市级
	 */
