     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='xuesheng'"  label="班级" prop="banji">
          <el-input v-model="ruleForm.banji"               placeholder="班级" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="住址省份" prop="zhuzhishengfen">
          <el-input v-model="ruleForm.zhuzhishengfen"               placeholder="住址省份" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="市级" prop="shiji">
          <el-input v-model="ruleForm.shiji"               placeholder="市级" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='xuesheng'"  label="县区" prop="xianqu">
          <el-input v-model="ruleForm.xianqu"               placeholder="县区" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
...
export default {
  ...
  methods: {
        ...
        return
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            if((!this.ruleForm.zhuzhishengfen)&& 'xuesheng'==this.flag){
        this.$message.error('住址省份不能为空');
        return
      }
                                                            if((!this.ruleForm.shiji)&& 'xuesheng'==this.flag){
        this.$message.error('市级不能为空');
        return
      }
                                                            if((!this.ruleForm.xianqu)&& 'xuesheng'==this.flag){
