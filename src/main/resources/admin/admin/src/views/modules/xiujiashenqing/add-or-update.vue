          ...
          <el-form-item class="input" label="休假天数" prop="xiujiatianshu">
              <el-input v-model="ruleForm.xiujiatianshu" 
                placeholder="休假天数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="行程城市" prop="xingchengchengshi">
          <el-input v-model="ruleForm.xingchengchengshi" 
              placeholder="行程城市" clearable  :readonly="ro.xingchengchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="行程城市" prop="xingchengchengshi">
              <el-input v-model="ruleForm.xingchengchengshi" 
                placeholder="行程城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="途经城市" prop="tujingchengshi">
          <el-input v-model="ruleForm.tujingchengshi" 
              placeholder="途经城市" clearable  :readonly="ro.tujingchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="途经城市" prop="tujingchengshi">
              <el-input v-model="ruleForm.tujingchengshi" 
                placeholder="途经城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiujiatianshu = true;
            continue;
	            	            ...
	            	            if(o=='xingchengchengshi'){
            this.ruleForm.xingchengchengshi = obj[o];
	    this.ro.xingchengchengshi = true;
            continue;
          }
	            	            if(o=='tujingchengshi'){
