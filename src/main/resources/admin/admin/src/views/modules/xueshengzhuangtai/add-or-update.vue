  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shentizhuangtai"
                placeholder="身体状态" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="核酸检测" prop="hesuanjiance">
          <el-select  @change="hesuanjianceChange" v-model="ruleForm.hesuanjiance" placeholder="请选择核酸检测">
            <el-option
                v-for="(item,index) in hesuanjianceOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.hesuanjiance" label="核酸检测" prop="hesuanjiance">
              <el-input v-model="ruleForm.hesuanjiance" 
                placeholder="核酸检测" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="核酸状态" prop="hesuanzhuangtai">
          <el-input v-model="ruleForm.hesuanzhuangtai" 
              placeholder="核酸状态" clearable  :readonly="ro.hesuanzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="核酸状态" prop="hesuanzhuangtai">
              <el-input v-model="ruleForm.hesuanzhuangtai" 
                placeholder="核酸状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="体温" prop="tiwen">
          <el-select  @change="tiwenChange" v-model="ruleForm.tiwen" placeholder="请选择体温">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.tiwen" label="体温" prop="tiwen">
              <el-input v-model="ruleForm.tiwen" 
                placeholder="体温" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体温状态" prop="tiwenzhuangtai">
          <el-input v-model="ruleForm.tiwenzhuangtai" 
              placeholder="体温状态" clearable  :readonly="ro.tiwenzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体温状态" prop="tiwenzhuangtai">
              <el-input v-model="ruleForm.tiwenzhuangtai" 
                placeholder="体温状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.gengxinriqi" label="更新日期" prop="gengxinriqi">
              <el-input v-model="ruleForm.gengxinriqi" 
                placeholder="更新日期" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="登记内容" prop="dengjineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dengjineirong" label="登记内容" prop="dengjineirong">
                    <span v-html="ruleForm.dengjineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	hesuanjiance : false,
	hesuanzhuangtai : false,
	tiwen : false,
	tiwenzhuangtai : false,
	gengxinriqi : false,
	dengjineirong : false,
	sfsh : false,
	shhf : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shentizhuangtai = true;
            continue;
	            	            ...
	            	            if(o=='hesuanjiance'){
            this.ruleForm.hesuanjiance = obj[o];
	    this.ro.hesuanjiance = true;
            continue;
          }
	            	            if(o=='hesuanzhuangtai'){
            this.ruleForm.hesuanzhuangtai = obj[o];
	    this.ro.hesuanzhuangtai = true;
            continue;
          }
	            	            if(o=='tiwen'){
	    ...
	    this.ro.tiwen = true;
            continue;
	            	            ...
	            	            if(o=='tiwenzhuangtai'){
            this.ruleForm.tiwenzhuangtai = obj[o];
	    this.ro.tiwenzhuangtai = true;
            continue;
          }
	            	            if(o=='gengxinriqi'){
    ...
    hesuanjianceChange () {
      this.$http({
        url: `follow/hesuanjiance/hesuanjiance?columnValue=`+ this.ruleForm.hesuanjiance,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.hesuanzhuangtai){
                this.ruleForm.hesuanzhuangtai = data.data.hesuanzhuangtai
              }
                                                                      if(data.data.tiwenzhuangtai){
                this.ruleForm.tiwenzhuangtai = data.data.tiwenzhuangtai
              }
                                                                                                                      } else {
          this.$message.error(data.msg);
        }
    ...
    tiwenChange () {
      this.$http({
        url: `follow/tiwenzhuangtai/tiwen?columnValue=`+ this.ruleForm.tiwen,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.hesuanzhuangtai){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueshengzhuangtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshengzhuangtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
