...
export default {
  data() {
	...
	tiwenzhuangtai : false,
            ...
            ruleForm: {
                  ...
                  tiwenzhuangtai: [
                            { required: true, message: '体温状态不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tiwenzhuangtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tiwenzhuangtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
