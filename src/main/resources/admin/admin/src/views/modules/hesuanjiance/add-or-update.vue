<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="核酸检测" prop="hesuanjiance">
          <el-input v-model="ruleForm.hesuanjiance" 
              placeholder="核酸检测" clearable  :readonly="ro.hesuanjiance"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="核酸检测" prop="hesuanjiance">
              <el-input v-model="ruleForm.hesuanjiance" 
  ...
  data() {
	...
	hesuanzhuangtai : false,
            ...
            ruleForm: {
                  ...
                  hesuanzhuangtai: [
                            { required: true, message: '核酸状态不能为空', trigger: 'blur' },
                                    	                                                              ],
              }
    };
  },
