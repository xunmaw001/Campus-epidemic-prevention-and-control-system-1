          ...
          <el-form-item class="input" label="班级" prop="banji">
              <el-input v-model="ruleForm.banji" 
                placeholder="班级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住址省份" prop="zhuzhishengfen">
          <el-input v-model="ruleForm.zhuzhishengfen" 
              placeholder="住址省份" clearable  :readonly="ro.zhuzhishengfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="住址省份" prop="zhuzhishengfen">
              <el-input v-model="ruleForm.zhuzhishengfen" 
                placeholder="住址省份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="市级" prop="shiji">
          <el-input v-model="ruleForm.shiji" 
              placeholder="市级" clearable  :readonly="ro.shiji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="市级" prop="shiji">
              <el-input v-model="ruleForm.shiji" 
                placeholder="市级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="县区" prop="xianqu">
          <el-input v-model="ruleForm.xianqu" 
              placeholder="县区" clearable  :readonly="ro.xianqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="县区" prop="xianqu">
              <el-input v-model="ruleForm.xianqu" 
                placeholder="县区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  data() {
	...
	youxiang : false,
            ...
            ruleForm: {
                  ...
                  zhuzhishengfen: [
                            { required: true, message: '住址省份不能为空', trigger: 'blur' },
                                    	                                                              ],
                  shiji: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
            continue;
	            	            ...
	            	            if(o=='zhuzhishengfen'){
            this.ruleForm.zhuzhishengfen = obj[o];
	    this.ro.zhuzhishengfen = true;
            continue;
          }
	            	            if(o=='shiji'){
