		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="班级" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="班级" type="text" />
												...
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">住址省份</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhuzhishengfen" class="input" type="text" placeholder="住址省份">
			   </div>
			 </div> -->
			<el-form-item label="住址省份" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.zhuzhishengfen" autocomplete="off" placeholder="住址省份" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">市级</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shiji" class="input" type="text" placeholder="市级">
			   </div>
			 </div> -->
			<el-form-item label="市级" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.shiji" autocomplete="off" placeholder="市级" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   <div class="label">县区</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xianqu" class="input" type="text" placeholder="县区">
			   </div>
			 </div> -->
			<el-form-item label="县区" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xianqu" autocomplete="off" placeholder="县区" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xuesheng'" class="input-group">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                          if((!this.ruleForm.zhuzhishengfen) && `xuesheng` == this.tableName){
        this.$message.error(`住址省份不能为空`);
        return
      }
                                                                  if((!this.ruleForm.shiji) && `xuesheng` == this.tableName){
        this.$message.error(`市级不能为空`);
        return
      }
                                                                  if((!this.ruleForm.xianqu) && `xuesheng` == this.tableName){
        this.$message.error(`县区不能为空`);
        return
      }
