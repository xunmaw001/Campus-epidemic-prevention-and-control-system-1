<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="登记标题" prop="dengjibiaoti">
          <el-input v-model="ruleForm.dengjibiaoti" 
              placeholder="登记标题" clearable  :readonly="ro.dengjibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="登记标题" prop="dengjibiaoti">
              <el-input v-model="ruleForm.dengjibiaoti" 
                placeholder="登记标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="登记类型" prop="dengjileixing">
          <el-select v-model="ruleForm.dengjileixing" placeholder="请选择登记类型">
            <el-option
                v-for="(item,index) in dengjileixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="登记类型" prop="dengjileixing">
	      <el-input v-model="ruleForm.dengjileixing"
                placeholder="登记类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
	...
	userid : false,
            ...
            ruleForm: {
                	        dengjibiaoti: '',
                                      ...
                                      dengjileixingOptions: [],
                                                                                                                                                                                                                        rules: {
                  dengjibiaoti: [
                            { required: true, message: '登记标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  dengjileixing: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='dengjibiaoti'){
            this.ruleForm.dengjibiaoti = obj[o];
	    this.ro.dengjibiaoti = true;
            continue;
          }
	            	            if(o=='dengjileixing'){
            this.ruleForm.dengjileixing = obj[o];
	    this.ro.dengjileixing = true;
            continue;
          }
	            	            if(o=='dengjineirong'){
